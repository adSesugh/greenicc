...
@section('title') Add Setting @stop

@section('content')
<div class="container-fluid">
    <x-breadcrumb type="Setting" action="Add" />

    <div class="row">
        <div class="col-lg-12">
            <form class="" action="{{ route('settings.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card m-b-20">
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Creating a new settings</h4>
                                <hr>
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label">Business Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Business Name" value="{{ old('name') }}" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email address" value="{{ old('email') }}" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="url" id="google_url" name="google_url" class="form-control @error('google_url') is-invalid @enderror" placeholder="Google URL" value="{{ old('google_url') }}" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control @error('about_us') is-invalid @enderror" name="about_us" id="description" rows="6">{{ old('about_us') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card m-b-20"> 
                            <div class="card-body">
                                <div class="form-group float-center">
                                    <img src="{{URL::to('assets/images/users/logo.jpg')}}" id="logo" style="width:100%; height:250px; margin-top:10px;" alt="Greenicc">
                                    <div>
                                ...
                                <div class="form-group float-center">
                                    <img src="{{URL::to('assets/images/users/breadcrumb.jpg')}}" id="breadcrumb" style="width:100%; height:150px; margin-top:10px;" alt="Greenicc">
                                    <div>
                                ...
                                <div class="form-group float-center">
                                    <img src="{{URL::to('assets/images/users/background.jpg')}}" id="whyus_background" style="width:100%; height:250px; margin-top:10px;" alt="Greenicc">
                                    <div>
